...
export class HomePage extends React.Component<
  {
    tryCallId: (id: string) => void;
    yourId: string;
    acceptCall: VoidFunction;
    rejectCall: VoidFunction;
    ...
    return (
      <header className="HomePage-header">
        ...
        <CSSTransition
          ...
          <Slide
            closeHandler={
              this.state.isJoining ? this.closeSlide : this.unconfirmWorkout
            }
            className="HomePage-code-slide"
            title={this.state.hasCreated ? "Invite" : "Join Session"}>
            {this.state.hasCreated ? (
              <div>
                <p>Your sesh id: {this.props.yourId}</p>
                {this.props.inboundCallerId !== null ? (
                  <div>
                    <p>
                      {this.props.inboundCallerId} is requesting to join your
                      session!
                    </p>
                    <div className="d-flex">
                      <Icon
              ...
              <JoinSessionForm
                handleSubmit={x => this.props.tryCallId(x)}
